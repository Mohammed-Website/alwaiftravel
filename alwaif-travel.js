        ...
        if (messageBar.value.trim() !== "") {
            ...
            let botResponse = `
                <div class="chat response">
                    <img src="https://mohammed-website.github.io/alwaiftravel/%D9%85%D9%83%D8%AA%D8%A8-%D8%B3%D9%8A%D8%A7%D8%AD%D9%8A/%D9%85%D9%83%D8%AA%D8%A8-%D8%B3%D9%8A%D8%A7%D8%AD%D9%8A-%D8%A8%D8%AD%D8%B1%D9%8A%D9%86%D9%8A.png">
                    <span class="new">...</span>
                </div>
            `;
...
const sectionData = [
    {
        title: 'عروض تركيا',
        image_1: ['عروض-شركة-اللويف/عروض-تركيا/عرض-تركيا-1.jpg', 'اسطنبول & بورصة & صبنجة & جزيرة الاميرات'],
        image_2: ['عروض-شركة-اللويف/عروض-تركيا/عرض-تركيا-2.jpg', 'اسطنبول & بورصة & صبنجة & جزيرة الاميرات'],
        image_3: ['عروض-شركة-اللويف/عروض-تركيا/عرض-تركيا-3.jpg', 'اسطنبول & بورصة & صبنجة & جزيرة الاميرات'],
        image_4: ['عروض-شركة-اللويف/عروض-تركيا/عرض-تركيا-4.jpg', 'اسطنبول & بورصة & صبنجة'],
        image_5: ['عروض-شركة-اللويف/عروض-تركيا/عرض-تركيا-5.jpg', 'اسطنبول & بورصة & صبنجة'],
    },
        
    {
        title: 'عروض ماليزيا',
        image_1: ['عروض-شركة-اللويف/عروض-ماليزيا/عرض-ماليزيا-1.jpg', 'سلانجور & لنكاوي & كوالالمبور'],
        image_2: ['عروض-شركة-اللويف/عروض-ماليزيا/عرض-ماليزيا-2.jpg', 'سلانجور & لنكاوي & كوالالمبور'],
    },

    {
        title: 'عروض اندونيسيا',
        image_1: ['عروض-شركة-اللويف/عروض-اندونيسيا/عرض-اندونيسيا-1.jpg', 'بونشاك & جزيرة بالي & جاكرتا'],
        image_2: ['عروض-شركة-اللويف/عروض-اندونيسيا/عرض-اندونيسيا-2.jpg', 'بونشاك & جزيرة بالي & جاكرتا'],
    },
    
    {
        title: 'عروض تايلاند',
        image_1: ['عروض-شركة-اللويف/عروض-تايلاند/عرض-تايلاند-1.jpg', 'عرض تايلاند - بانكوك & بوكيت'],
        image_2: ['عروض-شركة-اللويف/عروض-تايلاند/عرض-تايلاند-2.jpg', 'عرض تايلاند - بانكوك & بوكيت'],
    },

    {
        title: 'عروض المالديف',
        image_1: ['عروض-شركة-اللويف/عروض-المالديف/عرض-المالديف-1.jpg', 'عرض المالديف - مالي'],
    },


    {
        title: 'عروض اسطنبول',
        image_1: ['عروض-شركة-اللويف/عروض-اسطنبول/عرض-اسطنبول-1.jpg', 'اسطنبول & بورصة & صبنجة'],
        image_2: ['عروض-شركة-اللويف/عروض-اسطنبول/عرض-اسطنبول-2.jpg', 'عرض اسطنبول - بورصة & صبنجة'],
    },


    {
        title: 'عروض اذربيجان',
        image_1: ['عروض-شركة-اللويف/عروض-اذربيجان/عرض-اذربيجان-1.jpg', 'شهر عسل - قوبا & باكو & قبالا'],
        image_2: ['عروض-شركة-اللويف/عروض-اذربيجان/عرض-اذربيجان-2.jpg', 'باكو & شاهداغ & قوبا'],
        image_3: ['عروض-شركة-اللويف/عروض-اذربيجان/عرض-اذربيجان-3.jpg', 'عرض اذربيجان - باكو & قبالا'],
    },
];
...
function openFullScreenImage(src, text) {
    ...
    whatsappButton.href = `https://wa.me/+966569590255?text=طلب%20حجز%20هذا%20العرض:%0A%0Ahttps://mohammed-website.github.io/alwaiftravel/${encodeURIComponent(src)}`;
...
let mughader_commentsArray = [
    ...
    },
    {
        ...
        comment: "شكرا شركة اللويف على اتقانكم  بالعمل وعلى خدمتكم الجميله بارك الله فيكم وفي جهودكم الى الاعلى بإذن",
        stars: 5
    },
    {
        profileImage: "https://mughader.com/مكتب-للسفر-والسياحة/مكتب-للسفر-والسياحة-3.png",
        personName: "ناصر الهزاع",
        comment: "اشكر طاقم شركة اللويف على تعاملهم معي يستاهلو كل خير ♥️♥️",
        stars: 5
    },
    {
        profileLetter: "F",
    ...
    },
    {
        ...
        comment: "نشكر شركة اللويف على جهوده وتمنى له دائم التوفيق و والــــنــــجـــــاح",
        stars: 5
    },
    {
        profileLetter: "H",
        personName: "Hala Abdullah",
        comment: "من افضل واحسن الي تعاملت معهم للامانة ولا غلطة والاسعار حلوه جدا ومعقولة مرا شككككرا  شركة اللويف للسياحة 💛🙏🏻",
        stars: 5
    },
    {
        profileLetter: "س",
        personName: "سامي الموسى",
        comment: "صراحه مجهود يشكر عليه من شركة اللويف للسفر والسياحة ومن افضل الشركات الي حريصه علئ ادق التفاصيل شركه تلبي جميع احتيجاتك وعن تجربه اتكلم صراحه تعاملهم جدا راقي بجميع الاماكن والاوقات ❤️❤️",
        stars: 5
    },
];
...
function mughader_generateComments(comments) {
    ...
    comments.forEach(({ profileLetter, profileImage, personName, comment, stars }, index) => {
        ...
        if (profileImage) {
            ...
            img.alt = `مكتب سياحي - شركة اللويف`;
            img.title = `مكتب سياحي - شركة اللويف`;
...
openWhatsAppNumber = function () {
    ...
    const whatsappNumber = "+966569590255";
