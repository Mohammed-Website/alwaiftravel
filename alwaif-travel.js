...
const sectionData = [
    {
        title: 'عروض تركيا',
        image_6: ['عروض-شركة-اللويف/عروض-تركيا/6.jpg', 'اسطنبول & بورصة & صبنجة & جزيرة الاميرات'],
        image_1: ['عروض-شركة-اللويف/عروض-تركيا/1.jpg', 'اسطنبول & بورصة & صبنجة & جزيرة الاميرات'],
        image_2: ['عروض-شركة-اللويف/عروض-تركيا/2.jpg', 'اسطنبول & بورصة & صبنجة & جزيرة الاميرات'],
        image_3: ['عروض-شركة-اللويف/عروض-تركيا/3.jpg', 'اسطنبول & بورصة & صبنجة & جزيرة الاميرات'],
        image_4: ['عروض-شركة-اللويف/عروض-تركيا/4.jpg', 'اسطنبول & بورصة & صبنجة'],
        image_5: ['عروض-شركة-اللويف/عروض-تركيا/5.jpg', 'اسطنبول & بورصة & صبنجة'],
    },
        
    {
        title: 'عروض ماليزيا',
        image_1: ['عروض-شركة-اللويف/عروض-ماليزيا/1.jpg', 'سلانجور & لنكاوي & كوالالمبور'],
        image_2: ['عروض-شركة-اللويف/عروض-ماليزيا/2.jpg', 'سلانجور & لنكاوي & كوالالمبور'],
    },

    {
        title: 'عروض اندونيسيا',
        image_1: ['عروض-شركة-اللويف/عروض-اندونيسيا/1.jpg', 'بونشاك & جزيرة بالي & جاكرتا'],
        image_2: ['عروض-شركة-اللويف/عروض-اندونيسيا/2.jpg', 'بونشاك & جزيرة بالي & جاكرتا'],
    },
    
    {
        title: 'عروض تايلاند',
        image_1: ['عروض-شركة-اللويف/عروض-تايلاند/1.jpg', 'عرض تايلاند - بانكوك & بوكيت'],
        image_2: ['عروض-شركة-اللويف/عروض-تايلاند/2.jpg', 'عرض تايلاند - بانكوك & بوكيت'],
    },

    {
        title: 'عروض المالديف',
        image_1: ['عروض-شركة-اللويف/عروض-المالديف/1.jpg', 'عرض المالديف - مالي'],
    },


    {
        title: 'عروض اسطنبول',
        image_1: ['عروض-شركة-اللويف/عروض-اسطنبول/1.jpg', 'اسطنبول & بورصة & صبنجة'],
        image_2: ['عروض-شركة-اللويف/عروض-اسطنبول/2.jpg', 'عرض اسطنبول - بورصة & صبنجة'],
    },


    {
        title: 'عروض اذربيجان',
        image_1: ['عروض-شركة-اللويف/عروض-اذربيجان/1.jpg', 'شهر عسل - قوبا & باكو & قبالا'],
        image_2: ['عروض-شركة-اللويف/عروض-اذربيجان/2.jpg', 'باكو & شاهداغ & قوبا'],
        image_3: ['عروض-شركة-اللويف/عروض-اذربيجان/3.jpg', 'عرض اذربيجان - باكو & قبالا'],
    },
];
        ...
        .then(data => {
            ...
            data.reverse().forEach(item => { // Reverse to show newest first
                ...
                <div class="indoforall_clint_rate_info_div indoforall_animate_on_scroll">
                    <img src="مكتب-سياحي/مكتب-سياحي-بحريني.webp" alt="اللويف للسفر والسياحة - مكتب سياحي" title="اللويف للسفر والسياحة - مكتب سياحي">
                    <h4>${name}</h4>
                </div>
